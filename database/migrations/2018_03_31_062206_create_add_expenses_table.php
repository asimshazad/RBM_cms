...
class CreateAddExpensesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Add_expenses", 'add_expenses', 'amount_date', 'fa-bolt', [
            ["category_id", "Select Category", "Dropdown", false, "", 0, 0, true, "@expense_categories"],
            ["amount", "Amount", "Currency", false, "", 0, 11, true],
            ["description", "Description", "Textarea", false, "", 0, 0, false],
            ["amount_date", "Date", "Date", false, "", 0, 0, false],
        ]);
    ...
    {
        if (Schema::hasTable('add_expenses')) {
            Schema::drop('add_expenses');
        }
    }
}
