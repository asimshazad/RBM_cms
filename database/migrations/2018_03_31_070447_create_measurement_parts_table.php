...
class CreateMeasurementPartsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Measurement_parts", 'measurement_parts', 'category_id', 'fa-th', [
            ["category_id", "Select Category", "Dropdown", false, "", 0, 0, true, "@measurement_categories"],
            ["part", "Measurement Part", "TextField", false, "", 0, 256, true],
        ]);
