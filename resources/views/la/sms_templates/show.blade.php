...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $sms_template->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("SMS_Templates", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/sms_templates/'.$sms_template->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("SMS_Templates", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.sms_templates.destroy', $sms_template->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/sms_templates') }}" data-toggle="tooltip" data-placement="right" title="Back to SMS Templates"><i class="fa fa-chevron-left"></i></a></li>
