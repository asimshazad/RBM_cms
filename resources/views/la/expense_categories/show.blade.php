...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $expense_category->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Expense_Categories", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/expense_categories/'.$expense_category->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Expense_Categories", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.expense_categories.destroy', $expense_category->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/expense_categories') }}" data-toggle="tooltip" data-placement="right" title="Back to Expense Categories"><i class="fa fa-chevron-left"></i></a></li>
